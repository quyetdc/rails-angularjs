...
(function(){
    ...
    app.directive('registrationTitle', function(){
        return {
            restrict: 'E',
            templateUrl: 'registration-title.html',
            ...
            controllerAs: 'registrationTitle'
        };
    });

    app.directive('avatarPart', function(){
        return {
            restrict: 'E',
            templateUrl: '_avatar_part.html.erb'
        }
    });
...
//    // Capital words and have __Controller
//    app.controller('StoreController', ['$http', function($http) {
//        // Set property of controller equals to gem
//        var store = this;
//
//        // initialize products to an empty array, since the page
////        will render before our data returns from out get request
//        store.products = gems;
//
//        // $http return a promise with callback method .success and .error
//        // if success -> get data
